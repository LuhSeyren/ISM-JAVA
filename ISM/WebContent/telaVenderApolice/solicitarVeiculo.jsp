      ...
      <div class="jumbotron">
        ...
        <div class="input-group mb-3">
          <select class="form-control" name="modelo">
            <option value="" selected disabled> Modelo do Veículo </option>
            ...
            <!-- Mais um milhão de opções-->
          </select>
        </div>
        
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="ano" placeholder="Ano do Veículo">
          <div class="input-group-append">
          </div>
          <input type="text" class="form-control" name="cor" placeholder="Cor do Veículo">
          <div class="input-group-append">
          </div>
        </div>
        
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="placa" placeholder="Placa do Veículo (Somente Letras e Números)">
          <div class="input-group-append">
          </div>
          <input type="text" class="form-control" name="renavam" placeholder="Renavam (Somente Números)">
          <div class="input-group-append">
          </div>
        </div>
